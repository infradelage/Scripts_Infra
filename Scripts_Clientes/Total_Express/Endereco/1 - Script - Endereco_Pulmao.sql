...
SELECT 1, 3, 'BLOCO', 2, 0, NULL, NULL, '.', 1, 0 UNION
...
SELECT 1, 7, 'NIVEL',     2, 0, NULL, NULL,'.', 1, 0 UNION
SELECT 1, 8, 'POSICAO',     2, 0, NULL, NULL,NULL, 1, 0 
...
update def_tipo_acesso_endereco set descricao = 'A PÉ (PULMAO)' where descricao like '%APÉ%' and id_tipo_endereco = 2 --PULMAO
update def_tipo_acesso_endereco set descricao = 'ESCADA (PULMAO)' where descricao like '%ESCADA%' and id_tipo_endereco = 2 --PULMAO
update def_tipo_acesso_endereco set descricao = 'EMPILHADEIRA (PULMAO)' where descricao like '%EMPILHEDEIRA%' and id_tipo_endereco = 2 --PULMAO
...
update mig_pulmao_trabalho set tipo_de_armazenamento = 'SEPARACAO' where tipo_de_armazenamento like '%SEPARAÇÃO%'

select DISTINCT classificacao from mig_pulmao_trabalho
update mig_pulmao_trabalho set classificacao = 'PULMAO' where classificacao like '%PULMÃO%'

select DISTINCT LADO from mig_pulmao_trabalho
update mig_pulmao_trabalho set LADO = 'IMPAR' where LADO like '%ÍMPAR%'
...
select distinct tipo_volume, 1, 1,1,1,0,null,0,0,0,0 from mig_pulmao_trabalho
...
ALTER TABLE log_produto_endereco 
NOCHECK CONSTRAINT FK_log_produto_endereco_endereco;  
GO 
...
ALTER TABLE log_produto_endereco 
CHECK CONSTRAINT FK_log_produto_endereco_endereco;  
GO 
...
AND NOT EXISTS (SELECT 1 FROM ENDERECO E WHERE E.endereco_completo = m1.LINHA AND ID_DEF = 1 AND NIVEL = 2)
and m2.id_def = 1
and m2.nivel = 1
...
--NIVEL 3 - XX
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco)
select distinct  1, 3, m1.BLOCO, m2.id_endereco, null, m1.BLOCO ,dlc.id_lote_classificacao,1
from mig_pulmao_trabalho m1, endereco m2, def_lote_classificacao dlc
where m2.endereco = m1.LINHA
and m1.classificacao_endereco = dlc.descricao
AND NOT EXISTS (SELECT 1 FROM ENDERECO E WHERE E.endereco_completo = m1.BLOCO AND ID_DEF = 1 AND NIVEL = 3)
and m2.id_def = 1
and m2.nivel = 2
...
select distinct 1, 4, m1.RUA, m2.id_endereco, null, m1.BLOCO+'.'+ m1.RUA, dlc.id_lote_classificacao,1,
...
where m2.endereco_completo = m1.BLOCO
...
and not exists(select 1 from endereco m11,  endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.LINHA + m1.BLOCO+'.'+ m1.RUA
				   and m11.id_pai = m22.id_endereco
				   and m22.id_pai = m33.id_endereco
				   and M33.ENDERECO_COMPLETO = m1.LINHA + m1.BLOCO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 1, 5, m1.LADO, m2.id_endereco, null, m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO , dlc.id_lote_classificacao,1,null, null, null
...
where m2.endereco_completo = m1.BLOCO+'.'+ m1.RUA
...
and not exists(select 1 from endereco m11, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.LINHA + m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 1, 6, m1.PREDIO, m2.id_endereco, null, m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO + m1.PREDIO, 
...
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO
and m2.id_pai = m4.id_endereco
...
and not exists(select 1 from endereco m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.LINHA + m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 1, 7, m1.NIVEL, m2.id_endereco, null,  m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL,
...
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo =  m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO
and m2.id_pai = m4.id_endereco
...
and not exists(select 1 from endereco m11, endereco m12, endereco m13, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.LINHA + m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 1, 8, m1.posicao, m2.id_endereco, null, m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL + m1.posicao, 
dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
from mig_pulmao_trabalho m1, endereco m2, endereco m3,endereco m5,endereco m6,endereco m7, endereco m4, def_lote_classificacao dlc, def_tipo_acesso_endereco dtac, 
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL
and m2.id_pai = m4.id_endereco
and m4.id_pai = m6.id_endereco
and m6.id_pai = m7.id_endereco
and m7.id_pai = m5.id_endereco
and m5.id_pai = M3.id_endereco
and M3.endereco_completo = m1.linha
and m2.id_def = 1 and m2.nivel = 7
and m1.classificacao_endereco = dlc.descricao
and DTAC.descricao = M1.tipo_de_acesso  
and dtac.id_tipo_endereco = 2 -- PULMAO
and dtve.descricao =  m1.tipo_volume
and dtae.descricao = m1.tipo_de_armazenamento
and not exists(select 1 from endereco m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m66, endereco m77, endereco m44
                   where m11.endereco_completo = m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL + m1.posicao  
				   and m11.id_pai = m12.id_endereco
				   and m12.id_pai = m77.id_endereco
				   and m77.id_pai= m66.id_endereco
				   and m66.id_pai = m55.id_endereco
				   and m55.id_pai = m22.id_endereco
				   and m22.id_pai = m33.id_endereco
				   and M33.ENDERECO_COMPLETO = m1.linha
				   and m33.id_pai = m44.id_endereco
...
--insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
--id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
--select distinct 1, 9, m1.APTO, m8.id_endereco, null, m1.GALPAO +'-'+ m1.LINHA + m1.RUA +'-' + m1.LADO + m1.PREDIO+'-'+m1.ANDAR+'-'+m1.APTO,
--dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
----select m7.*
--from mig_pulmao_trabalho m1, endereco m8,endereco m7, endereco m3, endereco m4, endereco m5, endereco m6, def_lote_classificacao dlc, def_tipo_acesso_endereco dtac, 
--def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
--where m8.endereco_completo = m1.GALPAO +'-'+ m1.LINHA + m1.RUA +'-' + m1.LADO + m1.PREDIO+'-'+m1.ANDAR
--and m8.id_pai = m7.id_endereco
--and m7.id_pai = m6.id_endereco
--and m6.id_pai = m5.id_endereco
--and m5.id_pai = m4.id_endereco
--and m4.id_pai = M3.id_endereco
--and M3.endereco_completo = m1.RUA
--and m8.id_def = 1 and m8.nivel = 8
--and m1.classificacao_endereco = dlc.descricao
--and DTAC.descricao = M1.tipo_de_acesso 
--and dtac.id_tipo_endereco = 2 -- PULMAO
--and dtve.descricao =  m1.tipo_volume
--and dtae.descricao = m1.tipo_de_armazenamento
--and not exists(select 1 from endereco m14, endereco m11, endereco m12, endereco m13, endereco m55, endereco m22, endereco m33, endereco m44, endereco m66
--                   where m14.endereco_completo = m1.GALPAO +'-'+ m1.LINHA + m1.RUA +'-' + m1.LADO + m1.PREDIO+'-'+m1.ANDAR
--				   and m14.id_pai = m11.id_endereco
--				   and m11.id_pai = m13.id_endereco
--				   and m13.id_pai = m12.id_endereco
--				   and m12.id_pai = m55.id_endereco
--				   and m55.id_pai = m22.id_endereco
--				   and m22.id_pai = m33.id_endereco
--				   and m33.id_pai = m44.id_endereco
--				   and M44.ENDERECO_COMPLETO = m1.RUA
--				   and m44.id_pai = m66.id_endereco
--				   and m66.endereco_completo = m1.classificacao)
