...
SELECT 2, 3, 'BLOCO', 3, 0, NULL, NULL, '.', 1, 0 UNION
...
SELECT 2, 7, 'NIVEL',     3, 0, NULL, NULL, '.', 1, 0 UNION
SELECT 2, 8, 'POSICAO',     3, 0, NULL, NULL, NULL, 1, 0
...
select DISTINCT tipo_de_armazenamento from mig_flowrack_trabalho
update mig_flowrack_trabalho set tipo_de_armazenamento = 'SEPARACAO' where tipo_de_armazenamento like '%SEPARAÇÃO%'

select DISTINCT classificacao from mig_flowrack_trabalho
update mig_flowrack_trabalho set classificacao = 'FLOWRACK'
...
AND NOT EXISTS (SELECT 2 FROM ENDERECO E WHERE E.endereco_completo = m1.LINHA AND ID_DEF = 2 AND NIVEL = 2)
and m2.id_def = 2
and m2.nivel = 1
...
--NIVEL 3 - XX
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco)
select distinct  2, 3, m1.BLOCO, m2.id_endereco, null, m1.BLOCO ,dlc.id_lote_classificacao,1
from mig_flowrack_trabalho m1, endereco m2, def_lote_classificacao dlc
where m2.endereco = m1.LINHA
and m1.classificacao_endereco = dlc.descricao
AND NOT EXISTS (SELECT 2 FROM ENDERECO E WHERE E.endereco_completo =m1.BLOCO AND ID_DEF = 2 AND NIVEL = 3)
and m2.id_def = 2
and m2.nivel = 2
...
select distinct 2, 4, m1.RUA, m2.id_endereco, null, m1.BLOCO +'.'+ m1.RUA, dlc.id_lote_classificacao,1,
...
and not exists(SELECT 2 FROM ENDERECO m11,  endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO + m1.RUA
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 5, m1.LADO, m2.id_endereco, null, m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO, dlc.id_lote_classificacao,1,null, null, null
...
and not exists(SELECT 2 FROM ENDERECO m11, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 6, m1.PREDIO, m2.id_endereco, null, m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO + m1.PREDIO, 
...
--and dtve.descricao =  m1.tipo_volume
--and dtae.descricao = m1.tipo_de_armazenamento
and not exists(SELECT 2 FROM ENDERECO m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO + m1.PREDIO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 7, m1.NIVEL, m2.id_endereco, null, m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO + m1.PREDIO +'.'+m1.NIVEL,
...
and dtve.descricao =  m1.tipo_volume
and dtae.descricao = m1.tipo_de_armazenamento
and not exists(SELECT 2 FROM ENDERECO m11, endereco m12, endereco m13, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO +'.'+ m1.RUA +'.'+ m1.LADO + m1.PREDIO +'.'+m1.NIVEL
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 8, m1.posicao, m2.id_endereco, null, m1.BLOCO+'.'+ m1.RUA+ '.' + m1.LADO+ m1.PREDIO+ '.'+ m1.NIVEL + m1.posicao, 
dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
from mig_flowrack_trabalho m1, endereco m2, endereco m3,endereco m5,endereco m6,endereco m7, endereco m4, def_lote_classificacao dlc, def_tipo_acesso_endereco dtac, 
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
...
and m5.id_pai = M3.id_endereco
and M3.endereco_completo = m1.linha
and m2.id_def = 2 and m2.nivel = 7
and m1.classificacao_endereco = dlc.descricao
and DTAC.descricao = M1.tipo_de_acesso  
and dtac.id_tipo_endereco = 3 -- PULMAO
and dtve.descricao =  m1.tipo_volume
...
--insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
--id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
--select distinct 2, 9, m1.APTO, m8.id_endereco, null, m1.GALPAO +'-'+ m1.LINHA + m1.RUA +'-' + m1.LADO + m1.PREDIO+'-'+m1.ANDAR+'-'+m1.APTO,
--dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
----select m7.*
--from mig_flowrack_trabalho m1, endereco m8,endereco m7, endereco m3, endereco m4, endereco m5, endereco m6, def_lote_classificacao dlc, def_tipo_acesso_endereco dtac, 
--def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
...
--and m4.id_pai = M3.id_endereco
--and M3.endereco_completo = m1.AREA
--and m8.ID_DEF = 2 and m8.nivel = 8
--and m1.classificacao_endereco = dlc.descricao
--and DTAC.descricao = M1.tipo_de_acesso 
--and dtac.id_tipo_endereco = 3 -- PULMAO
--and dtve.descricao =  m1.tipo_volume
--and dtae.descricao = m1.tipo_de_armazenamento
--and not exists(SELECT 2 FROM ENDERECO m14, endereco m11, endereco m12, endereco m13, endereco m55, endereco m22, endereco m33, endereco m44, endereco m66
...
--				   and m22.id_pai = m33.id_endereco
--				   and m33.id_pai = m44.id_endereco
--				   and M44.ENDERECO_COMPLETO = m1.GALPAO
