...
values (1, 2, 4, getdate(), getdate(), getdate(), getdate(), getdate(), 'delage','delage', 1, COD_OPER_LOGISTICA, 'Migra??o inicial de estoque', getdate()  )
