/*-------------------------------------------------------------------
-												 -
-- Criação da árvore de endereço - FLOWRACK - COM 2 NIVEIS FINAIS	-
-																	-
--					XX.XXX											-	
--                  11.011											-
-- 11	- ESTACAO													-
...
update mig_flowrack_trabalho set tipo_volume = 'PALLET PADRAO'  where tipo_volume like '%PALETE PADRÃO%'
...
update mig_flowrack_trabalho set SETOR = 'RODAPE'  where SETOR like '%RODAPÉ%'
