...
SELECT 2, 2, 'SETOR', 3, 1, NULL, NULL, NULL, 0, 0 UNION
SELECT 2, 3, 'RUA', 3, 0, NULL, NULL, '-', 1, 0 UNION
SELECT 2, 4, 'LADO',   3, 0, NULL, NULL,NULL, 0, 0 UNION
SELECT 2, 5, 'PREDIO',   3, 0, NULL, NULL,'-', 1, 0 UNION
SELECT 2, 6, 'NIVEL', 3, 0, NULL, NULL, '-', 1, 0 UNION
SELECT 2, 7, 'POSICAO', 3, 0, NULL, NULL, NULL, 1, 0 
...
select distinct setor2,2 from mig_flowrack_trabalho
where setor2 not in (select descricao from def_endereco_setor where descricao = setor2 and id_tipo = 3)
...
select distinct tipo_de_armazenamento,0,1 from mig_flowrack_trabalho
...
select distinct 2, 2,  m1.SETOR, m2.id_endereco, null, m1.SETOR, dlc.id_lote_classificacao,1
...
AND NOT EXISTS (SELECT 1 FROM ENDERECO E WHERE E.endereco_completo = m1.SETOR AND ID_DEF = 2 AND NIVEL = 2)
and m2.id_def = 2
and m2.nivel = 1

--NIVEL 3 - XX
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco)
select distinct  2, 3, m1.RUA, m2.id_endereco, null, m1.SETOR+m1.RUA ,dlc.id_lote_classificacao,1
from mig_flowrack_trabalho m1, endereco m2, def_lote_classificacao dlc
where m2.endereco_completo = m1.SETOR
and m1.classificacao_endereco = dlc.descricao
AND NOT EXISTS (SELECT 1 FROM ENDERECO E WHERE E.endereco_completo =  m1.SETOR+m1.RUA AND ID_DEF = 2 AND NIVEL = 3)
and m2.id_def = 2
and m2.nivel = 2
...
select distinct 2, 4, m1.LADO, m2.id_endereco, null,  m1.SETOR+m1.RUA + m1.LADO, dlc.id_lote_classificacao,1,
NULL, NULL, null
from mig_flowrack_trabalho m1, endereco m2, endereco m3, def_lote_classificacao dlc, def_tipo_volume_endereco dtve
where m2.endereco_completo =  m1.SETOR+m1.RUA
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 5, m1.PREDIO, m2.id_endereco, null, m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO, 
...
where m2.endereco_completo = m1.SETOR+m1.RUA + m1.LADO
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 6, m1.NIVEL, m2.id_endereco, null, m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO+ m1.NIVEL, 
...
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO
and m2.id_pai = m4.id_endereco
...
and not exists(select 1 from endereco m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO+ m1.NIVEL
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 2, 7, m1.POSICAO, m2.id_endereco, null, m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO+ m1.NIVEL+m1.POSICAO, 
dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
from mig_flowrack_trabalho m1, endereco m2, endereco m3,endereco m5, endereco m4, def_lote_classificacao dlc, def_tipo_acesso_endereco dtac, 
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO+ m1.NIVEL
and m2.id_pai = m4.id_endereco
and m4.id_pai = m5.id_endereco
and m5.id_pai = M3.id_endereco
--and M3.endereco_completo = m1.SETOR
...
and dtae.descricao = m1.tipo_de_armazenamento
and not exists(select 1 from endereco m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.SETOR+m1.RUA + m1.LADO + m1.PREDIO+ m1.NIVEL+m1.POSICAO
				   and m11.id_pai = m12.id_endereco
				   and m12.id_pai = m55.id_endereco
				   and m55.id_pai = m22.id_endereco
				   and m22.id_pai = m33.id_endereco
