...
--SELECT 1, 6, 'NIVEL',     2, 0, NULL, NULL,NULL, 1, 0 UNION
...
select * INTO mig_pulmao_trabalho  from mig_pulmao2
...
select distinct 1, 4, m1.RUA, m2.id_endereco, null, m1.BLOCO + m1.RUA + m1.separador1, dlc.id_lote_classificacao,1,
...
and not exists(select 1 from endereco m11,  endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO + m1.RUA + m1.separador1
...
insert endereco(id_def, nivel, endereco, id_pai, qtd_caixa, endereco_completo, id_lote_classificacao, cod_situacao_endereco,
id_tipo_acesso_endereco, id_tipo_Armazenamento, id_tipo_volume)
select distinct 1, 5, m1.PREDIO, m2.id_endereco, null, m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2, 
...
where m2.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 
...
and not exists(select 1 from endereco m11, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2
...
select distinct 1, 6, m1.NIVEL, m2.id_endereco, null, m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2 + m1.NIVEL, 
...
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO
and m2.id_pai = m4.id_endereco
...
and not exists(select 1 from endereco m11,endereco m12, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2 + m1.NIVEL
...
select distinct 1, 7, m1.POSICAO, m2.id_endereco, null, m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2 + m1.NIVEL + m1.POSICAO,
dlc.id_lote_classificacao,1,dtac.id_tipo_acesso_endereco, dtae.id_tipo_armazenamento_endereco,dtve.id_tipo_volume_endereco
...
def_tipo_volume_endereco dtve, def_tipo_armazenamento_endereco dtae
where m2.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2 + m1.NIVEL
and m2.id_pai = m4.id_endereco
...
and not exists(select 1 from endereco m11, endereco m12, endereco m13, endereco m55, endereco m22, endereco m33, endereco m44
                   where m11.endereco_completo = m1.BLOCO + m1.separador1 + m1.RUA + m1.separador1 + m1.PREDIO + m1.separador2 + m1.NIVEL + m1.POSICAO
...
where endereco_completo in (SELECT endereco_completo FROM mig_pulmao_trabalho MPT WHERE MPT.endereco_completo = endereco_completo)
...
where e.endereco_completo in (SELECT endereco_completo FROM mig_pulmao_trabalho MPT WHERE MPT.endereco_completo = endereco_completo)
...
AND e.endereco_completo in (SELECT endereco_completo FROM mig_pulmao_trabalho MPT WHERE MPT.endereco_completo = endereco_completo)  
