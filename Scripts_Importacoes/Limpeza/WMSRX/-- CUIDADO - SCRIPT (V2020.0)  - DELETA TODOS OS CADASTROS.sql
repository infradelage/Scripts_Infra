...
DELETE movimentacao_item_lote DBCC CHECKIDENT(conf_validacao, RESEED, 1)
GO


DELETE movimentacao_item DBCC CHECKIDENT(conf_validacao, RESEED, 1)
GO

DELETE movimentacao DBCC CHECKIDENT(conf_validacao, RESEED, 1)
GO
...
GO
DELETE produto_agrupamento_restricao DBCC CHECKIDENT(produto_agrupamento_restricao, RESEED, 1)
GO
DELETE grupo_restricao_produto
GO

DELETE produto_endereco_armazenagem DBCC CHECKIDENT(produto_agrupamento_restricao, RESEED, 1)
GO
...
DELETE veiculo DBCC CHECKIDENT(entrada_caminhao_pedido, RESEED, 1)
GO
