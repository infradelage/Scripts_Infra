...
DELETE pedido_item_multivolume DBCC CHECKIDENT(movimentacao, RESEED, 1)
GO 
...
DELETE onda_volume DBCC CHECKIDENT(onda, RESEED, 1)
GO
...
DELETE produto_endereco_armazenagem DBCC CHECKIDENT(produto_multivolume, RESEED, 1)
GO
...
DELETE caixa_esteira_entidade DBCC CHECKIDENT(entrada_caminhao_pedido, RESEED, 1)
GO
